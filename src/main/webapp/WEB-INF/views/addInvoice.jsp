...
<script>
    ...
    function display(result){
        const content = result.map((cust) => {
            return "<li onclick = selectInput(this)>" + cust.name + "</li>";
    ...
    function selectInput(li){
        const selectedName = li.innerText;
        inputBox.value = selectedName;

        const customerObj = customers.find(c => c.name === selectedName);
        if(customerObj) {
            document.getElementById("customerId").value = customerObj.id;
        }
